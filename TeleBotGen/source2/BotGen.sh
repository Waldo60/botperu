...
ShellBot.InlineKeyboardButton --button 'botao_conf' --line 1 --text 'MI ID' --callback_data '/id'
...
ShellBot.InlineKeyboardButton --button 'botao_user' --line 3 --text '💰 DONAR 💰' --callback_data  '1' --url 'https://www.paypal.me/ChumoGH'
